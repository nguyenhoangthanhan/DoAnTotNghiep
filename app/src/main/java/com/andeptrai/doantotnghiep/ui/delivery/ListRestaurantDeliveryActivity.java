...
import static com.andeptrai.doantotnghiep.URL.urlGetAllKindDelivery;

public class ListRestaurantDeliveryActivity extends AppCompatActivity implements ResetListRestaurantInterf {

    ImageView icPageBack;
    RecyclerView rvKindDelivery, rvListRestaurant;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_list_restaurant_delivery);

        restaurantArrayList = (ArrayList<Restaurant>) getIntent().getSerializableExtra("restaurantArrayListDelivery");

        icPageBack = findViewById(R.id.icPageBack);
        rvKindDelivery = findViewById(R.id.rvKindDelivery);
        rvListRestaurant = findViewById(R.id.rvListRestaurant);

        kindAdapter = new KindAdapter(kindArrayList, this, this);
        rvKindDelivery.setAdapter(kindAdapter);
        rvKindDelivery.setLayoutManager(new LinearLayoutManager(this, LinearLayoutManager.HORIZONTAL, false));
        getAllKind();
    ...
    private void getAllKind() {
        RequestQueue requestQueue = Volley.newRequestQueue(ListRestaurantDeliveryActivity.this);
        JsonArrayRequest arrayRequest = new JsonArrayRequest(Request.Method.GET, urlGetAllKindDelivery, null,
                new Response.Listener<JSONArray>() {
                    @Override
                    public void onResponse(JSONArray response) {
                        Toast.makeText(ListRestaurantDeliveryActivity.this, response.toString(), Toast.LENGTH_LONG).show();
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        Toast.makeText(ListRestaurantDeliveryActivity.this, error.toString(), Toast.LENGTH_LONG).show();
                    }
                });
